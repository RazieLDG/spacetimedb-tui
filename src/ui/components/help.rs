...
const SECTIONS: &[Section] = &[
    ...
    Section {
        ...
        bindings: &[
            ...
            Binding { key: ", / .",           desc: "Tables tab: previous / next page of rows" },
            Binding { key: "PgUp / PgDn",     desc: "Tables tab: page back / forward (alias for , / .)" },
            Binding { key: "n / p",           desc: "Scroll view by 20 rows (when no search active)" },
        ],
    },
    Section {
        ...
        bindings: &[
            ...
            Binding { key: "Enter",           desc: "Edit selected row (opens popup form, PK read-only)" },
            Binding { key: "U (shift-u)",     desc: "Update selected row (alias for Enter)" },
            Binding { key: "d / Del",         desc: "Delete selected row (asks for y/n confirm)" },
